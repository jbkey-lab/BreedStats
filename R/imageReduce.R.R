...
image.paths = read.xlsx("R:/Research General/Marshalltown_IA/Inbred Pictures/Images.Path.Inbredspics.xlsx",1)
...
for (i in index.inbreds) {
  ...
  resize = function(x=images){image_scale(image_scale(x,"640"),"480")} # percent down is smaller picture
