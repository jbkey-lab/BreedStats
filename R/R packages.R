...
if(!(suppressWarnings(suppressMessages(require(asreml, warn.conflicts = FALSE))))){
  install.packages("jbkey730/BreedStats/External Packages/asreml_4.1.0.160.zip", repos = NULL, type = "win.binary")
...
if(!(suppressWarnings(suppressMessages(require(DiGGer, warn.conflicts = FALSE))))){
  install.packages("jbkey730/BreedStats/External Packages/DiGGer_1.0.5.zip", repos = NULL, type = "win.binary")
