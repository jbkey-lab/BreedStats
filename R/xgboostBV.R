...
xgblinearBV = function(  hdp,
  ...
  for(name in names){
    ...
    assign(paste0(name,"_XGBlinearBV_",folder,"SbyField"), data.frame(preds.test))
  ...
  preds.test = cbind(EarHt_XGBlinearBV_21SSbyField,
                     GS.Late_XGBlinearBV_21SSbyField,
                     PCT.HOH_XGBlinearBV_21SSbyField,
                     Plt.Height_XGBlinearBV_21SSbyField,
                     RL.._XGBlinearBV_21SSbyField,
                     RL.Count_XGBlinearBV_21SSbyField,
                     SL.._XGBlinearBV_21SSbyField,
                     SL.Count_XGBlinearBV_21SSbyField,
                     StandCnt..Final._XGBlinearBV_21SSbyField,
                     Test.WT_XGBlinearBV_21SSbyField,
                     Y.M_XGBlinearBV_21SSbyField,
                     Yield_XGBlinearBV_21SSbyField)
  colnames(preds.test) = names

rm(EarHt_XGBlinearBV_21SSbyField,
   GS.Late_XGBlinearBV_21SSbyField,
   PCT.HOH_XGBlinearBV_21SSbyField,
   Plt.Height_XGBlinearBV_21SSbyField,
   RL.._XGBlinearBV_21SSbyField,
...
gc()
  ...
  openxlsx::write.xlsx(preds.test.agg, paste0(fdp,"A.Prop",folder,"_predsByFemale.xlsx"),rowNames=F,overwrite=T)
